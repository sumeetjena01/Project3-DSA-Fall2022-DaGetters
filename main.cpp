...
/*
 ...
 So, if the user wants to see a list of all the movies on IMDb, I have to read in all the movies from the .TSV file, and put them into a vector.
 From there, we will sort the movies
